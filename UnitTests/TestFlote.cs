...
namespace UnitTests
{
    ...
    public class TestFlote
    {
        ...
        public void Flota_DodajBrodZaTriRazličitaBrodaSlažeFlotuOdTriBroda()
        {
            ...
            var p1 = m.DajPoljaZaBrod(Orjentacija.Horizontalno, new Polje(0, 0), 5);
            Brod b1 = new Brod(p1);
            f.DodajBrod(b1);

            var p2 = m.DajPoljaZaBrod(Orjentacija.Vertikalno, new Polje(1, 3), 4);
            Brod b2 = new Brod(p2);
            f.DodajBrod(b2);

            var p3 = m.DajPoljaZaBrod(Orjentacija.Horizontalno, new Polje(4, 5), 3);
            Brod b3 = new Brod(p3);
            f.DodajBrod(b3);
        ...
        [TestMethod]
        public void Flota_GađajVračaPromašajZaPoljeKojeNijeUNitiJednomBrpduPOlje()
        {
            Mreža m = new Mreža(10, 10);
            Flota f = new Flota();
        ...
        [TestMethod]
        public void Flota_GađajVračaPogodakZaPolčjaKOjaSuUBrodu()
        {
            Mreža m = new Mreža(10, 10);
            Flota f = new Flota();
        ...
        [TestMethod]
        public void Flota_GađajVračaPotonućeZaZadnjePogođenoPoljePrvogBroda()
        {
            Mreža m = new Mreža(10, 10);
            Flota f = new Flota();

            var p1 = m.DajPoljaZaBrod(Orjentacija.Horizontalno, new Polje(0, 0), 3);
            Brod b1 = new Brod(p1);
            f.DodajBrod(b1);
        ...
        [TestMethod]
        public void Flota_GađajVračaPotonućeZaZadnjePogođenoPoljeDrugogBroda()
        {
            Mreža m = new Mreža(10, 10);
            Flota f = new Flota();
            ...
            var p2 = m.DajPoljaZaBrod(Orjentacija.Vertikalno, new Polje(1, 3), 2);
            Brod b2 = new Brod(p2);
            f.DodajBrod(b2);
